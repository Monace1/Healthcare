...
if (isset($_POST['submit'])) {
    ...
    $stmt = $mysqli->prepare("UPDATE doctors SET specilization=?, doctorName=?, address=?, docFees=?, contactno=?, docEmail=? WHERE id=?");
    $stmt->bind_param("sssissi", $docspecialization, $docname, $docaddress, $docfees, $doccontactno, $docemail, $did);

    if ($stmt->execute()) {
        echo "<script>alert('Doctor Details updated Successfully');</script>";
    } else {
        echo "<script>alert('An error occurred while updating Doctor Details');</script>";
    }
                                                    ...
                                                    <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="Doctorspecialization" class="form-control" required="required">
                                                                ...
                                                                <?php 
                                                                    $ret = $mysqli->query("SELECT * FROM doctorspecilization");
