...
if (isset($_POST['submit'])) {
    ...
    $stmt = $mysqli->prepare("UPDATE doctorSpecilization SET specilization=?, updationDate=? WHERE id=?");
    $stmt->bind_param("ssi", $specialization, $currentTime, $id);
    if ($stmt->execute()) {
                                                    ...
                                                    <form role="form" name="dcotorspcl" method="post">
                                                        <div class="form-group">
                                                            ...
                                                            <?php 
                                                                ...
                                                                $stmt->close();
                                                            ?>
                                                            <input type="text" name="doctorspecilization" class="form-control" value="<?php echo htmlentities($specialization); ?>" >
                                                        </div>
